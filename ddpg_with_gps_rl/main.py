...
from settings import CHECKPOINTS_PATH, TOTAL_EPISODES, TF_LOG_DIR, UNBALANCE_P
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train', type=bool, nargs='?', default=False,
    ...
    with trange(TOTAL_EPISODES) as t:
        for ep in t:
            ...
            for _ in range(10000):
                if RENDER_ENV and (ep % 20 == 0 or not LEARN):  # render the environment into GUI
                    env.render()
